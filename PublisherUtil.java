...
public final class PublisherUtil {
  ...
  public static int publish(String publishURL, String publishPath,
		String publishFiles, String publishPassword, String serverUserid,
		String serverPassword, Boolean overwrite, boolean mkdirs) {
 ...
 * @throws Exception 
  ...
  public static String publish(final String publishURL, final String publishPath, final File publishFiles[],
      final String publishPassword, final String serverUserid, final String serverPassword, final boolean overwrite) throws Exception {
	  System.out.println("[DEBUG] - Chamada a segunda funcao publish 'return self.publish mkdir true' !");
 ...
 * @throws Exception 
   */
  public static String publish(final String publishURL, final String publishPath, final File publishFiles[],
      final String publishPassword, final String serverUserid, final String serverPassword, final boolean overwrite, final boolean mkdirs) throws Exception {
    int status = -1;
    ...
    try {
    	...
    	System.out.println("Erro de publicação na classe publisher!" + e);
      ...
      if (status == HttpStatus.SC_OK) {
        ...
        if (postResult != null) {
          try {
            ...
            PublisherUtil.logger.error(null, e);
           // throw new Exception("Erro de publicação na classe publisher!" + e + " " +PublisherUtil.FILE_ADD_INVALID_USER_CREDENTIALS);
